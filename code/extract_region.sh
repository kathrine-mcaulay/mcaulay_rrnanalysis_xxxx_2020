...
# Inputs: target name, which is really the Outputs
# Outputs: data/<region>/rrnDB.align
#
# Use the following format for if else:
# if [[ logical question ]]
# then
#   <do stuff>
# fi
...
# If mothus executed successfully, then touch the files that might not have been generated in pcr.seqs because the sequences spanned the desired region's coordinates
